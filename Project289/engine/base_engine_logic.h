...
public:
	...
	virtual StrongActorPtr VCreateActor(const std::string& actorResource, TiXmlElement* overrides, DirectX::FXMMATRIX initialTransform, const ActorId serversActorId = INVALID_ACTOR_ID) override;
	virtual StrongActorPtr VCreateActor(const std::string& actorResource, TiXmlElement* overrides, const DirectX::XMFLOAT4X4* initialTransform, const ActorId serversActorId = INVALID_ACTOR_ID) override;
